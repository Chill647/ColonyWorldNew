//
//  DashBoardbottomViewCell.swift
//  Colony world ios
//
//  Created by Getepay 2022 on 20/12/22.
//RAJ changes
//RAJ changes
...
class DashBoardbottomViewCell: UITableViewCell {
   ...
   // let bannerImages = [UIImage(named: "ProfileDrawer"),UIImage(named: "GalleryDrawer"),UIImage(named: "PayDrawer"),UIImage(named: "EventDrawer"),UIImage(named: "PayHistoryDrawer"),UIImage(named: "CircularDrawer")]
    let bannerImages = [UIImage(named: "payNew"),UIImage(named: "EventNew"),UIImage(named: "CircularNew"),UIImage(named: "galleryNew")]
//    let bannerLabel = ["Profile","Gallery","Pay Now","Events","History","Circular"]
    let bannerLabel = ["Pay Maintenace","Event","Circular","Gallery"]
...
extension DashBoardbottomViewCell:UICollectionViewDelegate,UICollectionViewDataSource{
...
extension DashBoardbottomViewCell:UICollectionViewDelegateFlowLayout{
